...
<html>
	...
	<head>
		...
		<title>lemon | mídia interativa</title>
	...
	<body class="page">
		...
		<header role="banner" class="transparent light">
			<div class="row">
				<div class="nav-inner row-content buffer-left buffer-right even clear-after">
					<div id="brand">
						<h1 class="reset"><img src="img/img_logo.png" alt="logo"></h1>
					</div><!-- brand -->
		...
		<main role="main">
			<div id="intro-wrap">
				<div id="intro" class="preload" data-autoplay="5000" data-navigation="true" data-pagination="true" data-transition="fade">					
                    ...
                    <div class="intro-item" style="background:url(img/bg_yellowlemon_2.jpg)">		
						<div class="intro-mockup-wrapper">		
							<div class="caption-mockup caption-right column six last-special">
								...
								<p>Take care of your design and build awesome apps.
									<br>Designed by <a href="http://dribbble.com/rickwaalders">Rick Waalders</a></p>
								<a class="button white transparent" href="#">Read More</a>
							</div><!-- caption -->
							<div class="intro-mockup intro-left column six">
								<img src="img/intro-mockup-03.png" alt="">
							</div><!-- intro-mockup -->							
					...
					<div class="intro-item" style="background-color: #f5be55;">
						<div class="intro-mockup-wrapper">						
							...
							<div class="photocaption">
								<h4>Shot by <a href="http://dribbble.com/noptar">Mani</a></h4>
							</div><!-- photocaption -->													
							<div class="intro-mockup">
								<img src="img/intro-mockup-01.png" alt="">
							</div><!-- intro-mockup -->	
						</div><!-- intro-mockup-wrapper -->										
					</div>
					<div class="intro-item" style="background-color: #6b3f4f;">
						<div class="intro-mockup-wrapper">
							<div class="caption-mockup caption-left column six">
								...
								<br>Designed by <a href="http://dribbble.com/anwaltzzz">Alexander Zaytsev</a>.</p>
								<a class="button white transparent" href="#">Read More</a>
							</div><!-- caption -->												
							<div class="intro-mockup intro-right column six last">
								<img src="img/intro-mockup-02.png" alt="">
							</div><!-- intro-mockup -->	
						</div><!-- intro-mockup-wrapper -->
					</div>	
					<div class="intro-item" style="background-color: #32cba3;">
						<div class="intro-mockup-wrapper">						
							...
							<div class="intro-mockup">
								<img src="img/intro-mockup-05.png" alt="">
							</div><!-- intro-mockup -->	
						</div><!-- intro-mockup-wrapper -->										
					</div>
				</div><!-- intro -->
			...
			<div id="main">
				...
				<section class="row section call-to-action">
					<div class="row-content buffer even">
						...
						<a class="button aqua" href="http://themeforest.net/item/beetle-html-responsive-html5-template/7129185?ref=mokaine">Buy it now!</a>
					</div>
				</section>
					...
					<div class="row-content buffer even clear-after">	
						...
						<div class="side-mockup right-mockup animation">
							<div class="slider ipad-slider grey" data-autoplay="3000">
								<figure>
									<div><img src="img/ipad-02.jpg" alt=""></div>
									<div><img src="img/ipad-03.jpg" alt=""></div>
									<div><img src="img/ipad-04.jpg" alt=""></div>
								</figure>
							</div>
						</div>
					</div>	
					...
					<div class="row-content buffer even clear-after">
						...
						<div class="side-mockup left-mockup animation">
							<div class="slider iphone-slider black" data-autoplay="3000">
								<figure>
									<div><img src="img/iphone-02.jpg" alt=""></div>
									<div><img src="img/iphone-03.jpg" alt=""></div>
									<div><img src="img/iphone-01.jpg" alt=""></div>
									<div><img src="img/iphone-04.jpg" alt=""></div>
									<div><img src="img/iphone-05.jpg" alt=""></div>
								</figure>
							</div>
						</div>						
					</div>	
				...
				<section class="row section text-light" style="background-color:#434A54">
					<div class="row-content buffer even clear-after">					
						<div class="slider desktop-slider white-controls" data-autoplay="3000">
							<figure>
								<div><img src="img/desktop-03.jpg" alt=""></div>
								<div><img src="img/desktop-04.jpg" alt=""></div>
								<div><img src="img/desktop-05.jpg" alt=""></div>
								<div><img src="img/desktop-06.jpg" alt=""></div>
								<div><img src="img/desktop-07.jpg" alt=""></div>
								<div><img src="img/desktop-08.jpg" alt=""></div>
								<div><img src="img/desktop-09.jpg" alt=""></div>
							</figure>
						</div>
					</div>	
				</section>	
				...
				<section class="row section text-light" style="background-color:#3BAFDA;">
					<div class="row-content buffer even clear-after">
						...
						<div class="testimonial-slider" data-autoplay="5000" data-pagination="true" data-transition="fade" data-autoheight="false">
							<div class="quote">
								...
								<div class="column ten last">
									...
									<div class="author">Helen Beck</div>
								</div><!-- column -->
							</div><!-- quote -->
							<div class="quote">
								<div class="column two">
								...
								<div class="column ten last">								
									...
									<div class="author">Craig Edwards</div>
								</div><!-- column -->
							</div><!-- quote -->		
							<div class="quote">
								<div class="column two">
								...
								<div class="column ten last">									
									...
									<div class="author">Michael Dean</div>
								</div><!-- column -->									
							</div><!-- quote -->							
				...
				<section class="row section call-to-action">
					<div class="row-content buffer even animation">
						<p>Have you fallen in love with Beetle?</p>
						<a class="button red" href="http://themeforest.net/item/beetle-html-responsive-html5-template/7129185?ref=mokaine">Buy it now!</a>
					</div>
				</section>				
					...
					<section id="top-footer">
						<div class="widget column three"><!-- la class="widget" è forse generata utomaticamente da wp -->
							...
							<ul class="plain">
								...
								<li><a href="file:///Users/pasqualevitiello/My Folder/Job/Envato/PR Themeforest/Flattie/Markup/Beetle/contact.html">Contact</a></li>
							</ul>
						</div>
		...
		<script>
		  ...
		  ga('create', 'UA-49063880-1', 'mokaine.com');
		  ga('send', 'pageview');
		</script>			
